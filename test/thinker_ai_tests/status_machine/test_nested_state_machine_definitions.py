...
class TestNestedStateMachine(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # 读取状态机实例
        self.state_machine = self.instance_repo.get("group_instance","outer_instance")
    ...
    def test_combined_state_machine(self):
        ...
        middle_state_machine = self.instance_repo.get("group_instance","outer_start_instance")
