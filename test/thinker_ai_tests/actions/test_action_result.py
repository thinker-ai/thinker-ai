...
class TestActionResult(unittest.TestCase):
    ...
    def test_plain_text(self):
        ...
        mapping = {"Title": (str, ...)}
        action_result = ActionResult.deserialize(text, mapping)
        self.assertEqual(action_result.instance.Title, "This is a simple text block.")
    ...
    def test_list_parsing(self):
        ...
        mapping = {"List": (list, ...)}
        action_result = ActionResult.deserialize(text, mapping)
        self.assertEqual(action_result.instance.List, ['item1', 'item2'])
    ...
    def test_dict_parsing(self):
        ...
        action_result = ActionResult.deserialize(text, mapping)
        self.assertEqual(action_result.instance.Dictionary, {'key1': 'value1', 'key2': 'value2'})
