...
from thinker_ai.agent.memory import AgentLongTermMemory
...
class TestLongTermMemory(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.memory = AgentLongTermMemory('agent1', self.file_path)
    ...
    def test_file_save_and_load(self):
        ...
        new_memory = AgentLongTermMemory('agent1', self.file_path)
