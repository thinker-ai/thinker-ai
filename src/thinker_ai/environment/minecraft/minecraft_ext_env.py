...
from thinker_ai.environment.base_env import ExtEnv, mark_as_writeable
from thinker_ai.environment.base_env_space import BaseEnvAction, BaseEnvObsParams
from thinker_ai.environment.minecraft.const import (
    MC_CKPT_DIR,
...
from thinker_ai.environment.minecraft.process_monitor import SubprocessMonitor
    ...
    def _post_init_ext_env(self):
        if not self.mineflayer:
            self.mineflayer = SubprocessMonitor(
                commands=[
                    "node",
                    PROJECT_ROOT.joinpath("thinker_ai", "environment", "minecraft", "mineflayer", "index.js"),
