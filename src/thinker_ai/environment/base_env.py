...
from thinker_ai.agent.provider.schema import Message, is_send_to
from thinker_ai.common.common import is_coroutine_func

if TYPE_CHECKING:
    from thinker_ai.agent.roles.role import Role  # noqa: F401
