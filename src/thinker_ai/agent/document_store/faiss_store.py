...
from thinker_ai.agent.document_store.base_store import LocalStore
from thinker_ai.agent.document_store.document import IndexableDocument
...
class FaissStore(LocalStore):
    ...
    def _write(self, docs: list[str], metadatas: list[dict[str, Any]]) -> VectorStoreIndex:
        ...
        vector_store = FaissVectorStore(faiss_index=AnnoyIndex(1536, 'euclidean'))
