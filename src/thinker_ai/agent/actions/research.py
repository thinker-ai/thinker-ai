...
from thinker_ai.agent.tools.web_browser_engine import WebBrowserEngine
...
from thinker_ai.utils.text import generate_prompt_chunk, reduce_message_length
...
class CollectLinks(Action):
    ...
    async def run(
        ...
        prompt = reduce_message_length(gen_msg(), model_name, system_text, config.client.max_token)
        logger.debug(prompt)
