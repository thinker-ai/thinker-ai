...
@Time    : 2023/8/18
@Author  : mashenquan
@File    : thinker_ai_text_to_image.py
@Desc    : ThinkerAI Text-to-Image OAS3 api, which provides text-to-image functionality.
"""
import base64
...
# Export
async def oas3_thinker_ai_text_to_image(text, size_type: str = "512x512", model_url=""):
    """Text to image
    ...
    if not text:
        return ""
    return await ThinkerAIText2Image(model_url).text_2_image(text, size_type=size_type)
