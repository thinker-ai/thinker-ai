...
from thinker_ai.agent.tools.azure_tts import oas3_azsure_tts
from thinker_ai.agent.tools.iflytek_tts import oas3_iflytek_tts
...
async def text_to_speech(
    ...
    style="affectionate",
    role="Girl",
    config: Config = thinker_ai.configs.config.config,
):
    """Text to speech
