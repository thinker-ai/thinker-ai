...
from thinker_ai.agent.rag.interface import RAGObject
...
class ChromaRetrieverConfig(IndexRetrieverConfig):
    ...
    collection_name: str = Field(default="thinker_ai", description="The name of the collection.")
...
class ElasticsearchStoreConfig(BaseModel):
    index_name: str = Field(default="thinker_ai", description="Name of the Elasticsearch index.")
