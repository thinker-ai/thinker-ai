...
from thinker_ai.agent.actions.invoice_ocr import GenerateTable, InvoiceOCR, ReplyQuestion
from thinker_ai.agent.prompts.invoice_ocr import INVOICE_OCR_SUCCESS
