...
class AgentThinker(Role):
    ...
    def __init__(self, instance_id: str, thinker_info: ThinkerInfo):
        super().__init__(thinker_info)
        self.instance_id = instance_id
        self.speaker = Speaker()

    async def chat(self,msg: str) -> BaseModel:
        ai_data = self._ai_process(msg)
    ...
    def _ai_process(self, msg: str) -> DataModel:
