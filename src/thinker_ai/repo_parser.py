...
from thinker_ai.common.common import remove_white_spaces, aread
...
from thinker_ai.configs.const import GENERALIZATION, COMPOSITION, AGGREGATION
...
class DotReturn(BaseModel):
    ...
    @classmethod
    def parse(cls, v: str) -> Union["DotReturn", None]:
        """
...
class RepoParser(BaseModel):
    ...
    @staticmethod
    def _split_relationship_line(line: str) -> Optional[DotClassRelationship]:
        """
